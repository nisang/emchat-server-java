package com.che.easemob.server.comm.invoker;
...
import com.che.easemob.server.comm.utils.RestAPIUtils;
...
public class HttpClientRestAPIInvoker implements RestAPIInvoker {
	...
	public ResponseWrapper sendRequest(String method, String url, HeaderWrapper header, BodyWrapper body, QueryWrapper query) {
		...
		if( !method.equals("GET") && (null == body || !body.validate()) ) {
        ...
        if( null != body && null != body.getBody() && !method.equals("GET")){
