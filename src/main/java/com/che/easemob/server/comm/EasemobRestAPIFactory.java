...
import com.che.easemob.server.api.RestAPIInvoker;
import com.che.easemob.server.comm.invoker.HttpClientRestAPIInvoker;
import com.che.easemob.server.comm.invoker.JerseyRestAPIInvoker;
...
public class EasemobRestAPIFactory {
	...
	private static final String BASE_PACKAGE = "com.che.easemob.server.api.impl";
	...
	public EasemobRestAPIFactory() {
		System.out.println("-----------------");
	}
	public EasemobRestAPIFactory(ClientContext context) {
